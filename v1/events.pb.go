...
type UserMovedEvent struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	UserId        string                 `protobuf:"bytes,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` // connected client/session ID, not persistent unique_id
	...
	MovedBy       string                 `protobuf:"bytes,4,opt,name=moved_by,json=movedBy,proto3" json:"moved_by,omitempty"` // connected client/session ID of the actor
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *UserBannedEvent) GetChannelId() string {
	if x != nil {
		return x.ChannelId
	}
	return ""
